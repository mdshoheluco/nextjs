                ...
                <div className="mx-auto max-w-screen-md sm:text-center">
                    ...
                    <form action="#">
                        <div className="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                            ...
                            <div>
                                <button type="submit" className="py-3 px-5 w-full text-sm font-medium text-center border cursor-pointer bg-secondary border-primary-600 sm:rounded-none sm:rounded-r-lg hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Subscribe</button>
                            </div>
                        </div>
